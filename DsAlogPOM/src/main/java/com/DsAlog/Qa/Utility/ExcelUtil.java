...
public class ExcelUtil extends Baseclass{
	...
	public void fillGreenColor(String sheetName, int rownum, int colnum, String path) throws IOException {
		fi = new FileInputStream(path);
		workbook = new XSSFWorkbook(fi);
		sheet = workbook.getSheet(sheetName);
	...
	public void fillRedColor(String sheetName, int rownum, int colnum, String path) throws IOException {
		fi = new FileInputStream(path);
		workbook = new XSSFWorkbook(fi);
		sheet = workbook.getSheet(sheetName);
		row = sheet.getRow(rownum);
